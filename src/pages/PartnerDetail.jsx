        ...
        <div className="space-y-6">
          <div className="rounded-2xl border border-navy/10 bg-white p-5">
            ...
            <div className="mt-4 space-y-3">
              ...
              {isOwner && ["super_vendor", "vendor", "sub_vendor", "dealer"].includes(partner.partner_type) && (partner.partner_type === "super_vendor" || partner.referred_by_partner_id) && partner.status === "approved" && !partner.partner_login_id && <button onClick={createPartnerLogin} disabled={creatingLogin} className="w-full rounded-full border border-navy/20 px-5 py-2.5 text-sm font-bold text-navy hover:border-amber disabled:opacity-60">{creatingLogin ? "Creating Login..." : "Create Partner Login"}</button>}
          ...
          {isOwner && ["super_vendor", "vendor", "sub_vendor", "dealer"].includes(partner.partner_type) && <div className="rounded-2xl border border-navy/10 bg-white p-5">
